...
$from = "sasaki.webwork+send@gmail.com";
...
佐々木 大
TEL：090- 6620 - 3215 　
E-mail:sasaki.webwork@gmail.com
URL: http://sasakiweb.work/
──────────────────────
...
.check{background:#3e5cc5;}
.check .formwrap{ color:#fff;}
.check h2, .check h3, .check p{text-align: center;}
.check h2{
...
<h3>入力ミス</h3>
<h4>入力内容にエラーがあります。 <br>
下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
...
body{background:#3e5cc5;}
.check .formwrap{ color:var(--white);color:#fff;}
.check h2, .check h3, .check p{text-align: center;}
.check h2{
font-family: "Andale Mono";
font-size:4em;
...
<body class="check">
<main>
  <section id="contact" class="thanks container" data-section-name="Contact">
...
<br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()">
    ...
    <section class="copyright">
        <p>SASAKI WEBWORK All rights reserved.</p>
    </section>
</footer>
</body>
</html>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NLG8MNB"
  ...
  <section id="contact" class="thanks container" data-section-name="Contact">
    <section class="contents">
        <section class="description">
            ...
            <p>２〜３営業日以内にご連絡させていただきます。<br>
                ご返信が無い場合は、再度こちらよりお知らせください。
            </p>
            <a href="../index.html"><button>TOPに戻る</button></a>
        </section>
...
<script type="text/javascript" src="js/scrolify.js"></script>
